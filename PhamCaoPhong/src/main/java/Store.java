...
public class Store {
    ...
    public float getBalance() {
        float total = 0;
        for (Map.Entry<String, TransactionOutput> item: PCP_BlockChain.UTXOs.entrySet()){
    ...
    public Transaction sendFunds(PublicKey _recipient,float value ) {
        if(getBalance() < value) {
            System.out.println("#Số điện thoại không đủ để chuyển kho khác, giao dịch chuyển bị hủy!");
            return null;
        }
